...
<html lang="en">
  ...
  <body class="app flex-row align-items-center">
          ...
          <div class="card-group">
            ...
            <div class="card text-white bg-primary py-5 d-md-down-none" style="width:44%">
              <div class="card-body text-center">
                <img src="/assets/admin-template/img/1.png" alt="gambar" style="height:auto; width:310px;">
              </div>
            </div>
          </div>
        </div>
    ...
    <script src="/assets/admin-template//assets/admin-template/node_modules/jquery/dist/jquery.min.js"></script>
